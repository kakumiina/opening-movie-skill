...
本スキルは無償配布です（MITライセンス）。自由に使用・改変・再配布でき、商用利用も可能です。

- **動作保証はありません。** 作者の環境で確認しているだけです
- **ご利用は自己責任でお願いします。** 生じた損害について責任は負いません
- **素材の権利はご自身でご確認ください。** 生成画像の商用利用可否、実在の人物に似た画像の肖像権、公開時の被写体の同意など
- **サポートはありません。** GitHub の Issue は歓迎しますが、返答は保証できません
